...
// testIpcNonePrivateShareable is a helper function to testdata "none",
...
// testIpcContainer is a helper function to testdata --ipc container:NNN mode in various scenarios
